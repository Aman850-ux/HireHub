        ...
        <header className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            ...
            <p className="mt-3 text-gray-600 max-w-2xl">
              ...
              We focus on quality listings, verified employers and a great user
              experience so you can find the right role faster.
            </p>
          </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      Trusted and optimized for your job search.
                    </p>
                  </div>
                </div>

                <span className="absolute -right-10 -bottom-10 opacity-10 text-6xl font-bold text-indigo-600 pointer-events-none">
                  {i + 1}
                </span>
              </div>
            ))}
